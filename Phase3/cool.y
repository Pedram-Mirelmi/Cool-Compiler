  ...
  #define cool_yylloc curr_lineno  /* use the curr_lineno from the lexer for the location of tokens */
    ...
    */
    ...
    class	
    	...
    	| 	
    		CLASS TYPEID INHERITS TYPEID '{' class_body '}' ';'
	    	{ 
	    		$$ = class_($2, $4, $6, stringtable.add_string(curr_filename));
	    	}
		|       CLASS TYPEID INHERITS error '{' class_body '}' ';'
			{
				yyerrok;
			}
		|
    ...
    let_body
    	:	
    		OBJECTID ':' TYPEID ',' let_body    			%prec LET_STMT
    		{
    			$$ = let($1, $3, no_expr(), $5);
    		}
    	|	
    		OBJECTID ':' TYPEID ',' error	    			%prec LET_STMT
    			{yyerrok;}
    	|
    		OBJECTID ':' TYPEID ASSIGN expr ',' let_body 		%prec LET_STMT
    		{
    			$$ = let($1, $3, $5, $7);
    		}
    	|
    		OBJECTID ':' error ',' let_body	 			%prec LET_STMT
    			{yyerrok;}
    	|
    		error ':' TYPEID ASSIGN expr ',' let_body 		%prec LET_STMT
    			{yyerrok;}
    	|
